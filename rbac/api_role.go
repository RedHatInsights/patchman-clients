...
*/
func (a *RoleApiService) ListRoles(ctx _context.Context, localVarOptionals *ListRolesOpts) (RolePagination, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodGet
		localVarPostBody     interface{}
		localVarFormFileName string
		localVarFileName     string
		localVarFileBytes    []byte
		localVarReturnValue  RolePagination
	)
