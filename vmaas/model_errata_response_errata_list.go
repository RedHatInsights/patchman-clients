...
// GetReleaseVersions returns the ReleaseVersions field value if set, zero value otherwise.
func (o *ErrataResponseErrataList) GetReleaseVersions() []string {
	if o == nil || o.ReleaseVersions == nil {
		var ret []string
		return ret
	}
	return *o.ReleaseVersions
}

// GetReleaseVersionsOk returns a tuple with the ReleaseVersions field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *ErrataResponseErrataList) GetReleaseVersionsOk() (*[]string, bool) {
	if o == nil || o.ReleaseVersions == nil {
		return nil, false
	}
	return o.ReleaseVersions, true
}
...
// SetReleaseVersions gets a reference to the given []string and assigns it to the ReleaseVersions field.
...
func (o ErrataResponseErrataList) MarshalJSON() ([]byte, error) {
	...
	if o.ReleaseVersions != nil {
		toSerialize["release_versions"] = o.ReleaseVersions
	}
