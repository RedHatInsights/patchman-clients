...
type VulnerabilitiesResponse struct {
	CveList []OneOfstringobject `json:"cve_list"`
	ManuallyFixableCveList []OneOfstringobject `json:"manually_fixable_cve_list"`
	UnpatchedCveList []OneOfstringobject `json:"unpatched_cve_list"`
