...
**OptimisticUpdates** | Pointer to **bool** | Search for updates of unknown package EVRAs. | [optional] [default to false]
...
GetOptimisticUpdates returns the OptimisticUpdates field if non-nil, zero value otherwise.

### GetOptimisticUpdatesOk

`func (o *UpdatesV3Request) GetOptimisticUpdatesOk() (*bool, bool)`

GetOptimisticUpdatesOk returns a tuple with the OptimisticUpdates field if it's non-nil, zero value otherwise
and a boolean to check if the value has been set.
...
SetOptimisticUpdates sets OptimisticUpdates field to given value.
