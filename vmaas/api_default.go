...
func (a *DefaultApiService) AppCVEHandlerGetGetExecute(r ApiAppCVEHandlerGetGetRequest) (CvesResponse, *_nethttp.Response, error) {
	...
	localVarPath := localBasePath + "/v1/cves/{cve}"
...
func (a *DefaultApiService) AppDBChangeHandlerGetExecute(r ApiAppDBChangeHandlerGetRequest) (DBChangeResponse, *_nethttp.Response, error) {
	...
	localVarPath := localBasePath + "/v1/dbchange"
...
func (a *DefaultApiService) AppErrataHandlerGetGetExecute(r ApiAppErrataHandlerGetGetRequest) (ErrataResponse, *_nethttp.Response, error) {
	...
	localVarPath := localBasePath + "/v1/errata/{erratum}"
...
func (a *DefaultApiService) AppErrataHandlerPostPostExecute(r ApiAppErrataHandlerPostPostRequest) (ErrataResponse, *_nethttp.Response, error) {
	...
	localVarPath := localBasePath + "/v1/errata"
...
func (a *DefaultApiService) AppHealthHandlerGetExecute(r ApiAppHealthHandlerGetRequest) (*_nethttp.Response, error) {
	...
	localVarPath := localBasePath + "/v1/monitoring/health"
...
func (a *DefaultApiService) AppPackagesHandlerGetGetExecute(r ApiAppPackagesHandlerGetGetRequest) (PackagesResponse, *_nethttp.Response, error) {
	...
	localVarPath := localBasePath + "/v1/packages/{nevra}"
...
func (a *DefaultApiService) AppPatchesHandlerGetGetExecute(r ApiAppPatchesHandlerGetGetRequest) (PatchesResponse, *_nethttp.Response, error) {
	...
	localVarPath := localBasePath + "/v1/patches/{nevra}"
	localVarPath = strings.Replace(localVarPath, "{"+"nevra"+"}", _neturl.PathEscape(parameterToString(r.nevra, "")), -1)
...
func (a *DefaultApiService) AppPkgtreeHandlerGetGetExecute(r ApiAppPkgtreeHandlerGetGetRequest) (PkgtreeResponse, *_nethttp.Response, error) {
	...
	localVarPath := localBasePath + "/v1/pkgtree/{package_name}"
...
func (a *DefaultApiService) AppPkgtreeHandlerPostPostExecute(r ApiAppPkgtreeHandlerPostPostRequest) (PkgtreeResponse, *_nethttp.Response, error) {
	...
	localVarPath := localBasePath + "/v1/pkgtree"
...
func (a *DefaultApiService) AppReadyHandlerGetExecute(r ApiAppReadyHandlerGetRequest) (*_nethttp.Response, error) {
	...
	localVarPath := localBasePath + "/v1/monitoring/ready"
...
func (a *DefaultApiService) AppReposHandlerGetGetExecute(r ApiAppReposHandlerGetGetRequest) (ReposResponse, *_nethttp.Response, error) {
	...
	localVarPath := localBasePath + "/v1/repos/{repo}"
...
func (a *DefaultApiService) AppReposHandlerPostPostExecute(r ApiAppReposHandlerPostPostRequest) (ReposResponse, *_nethttp.Response, error) {
	...
	localVarPath := localBasePath + "/v1/repos"
...
type ApiAppUpdatesHandlerGetGetRequest struct {
	ctx _context.Context
	ApiService *DefaultApiService
	nevra string
}
...
func (r ApiAppUpdatesHandlerGetGetRequest) Execute() (UpdatesResponse, *_nethttp.Response, error) {
	return r.ApiService.AppUpdatesHandlerGetGetExecute(r)
}
 ...
 * @param ctx _context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param nevra Package NEVRA
 * @return ApiAppUpdatesHandlerGetGetRequest
 */
func (a *DefaultApiService) AppUpdatesHandlerGetGet(ctx _context.Context, nevra string) ApiAppUpdatesHandlerGetGetRequest {
	return ApiAppUpdatesHandlerGetGetRequest{
		ApiService: a,
		ctx: ctx,
		nevra: nevra,
 ...
 */
func (a *DefaultApiService) AppUpdatesHandlerGetGetExecute(r ApiAppUpdatesHandlerGetGetRequest) (UpdatesResponse, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodGet
		localVarPostBody     interface{}
		localVarFormFileName string
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "DefaultApiService.AppUpdatesHandlerGetGet")
	if err != nil {
		return localVarReturnValue, nil, GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/v1/updates/{nevra}"
	localVarPath = strings.Replace(localVarPath, "{"+"nevra"+"}", _neturl.PathEscape(parameterToString(r.nevra, "")), -1)
...
type ApiAppUpdatesHandlerPostPostRequest struct {
	ctx _context.Context
	ApiService *DefaultApiService
	updatesRequest *UpdatesRequest
}

func (r ApiAppUpdatesHandlerPostPostRequest) UpdatesRequest(updatesRequest UpdatesRequest) ApiAppUpdatesHandlerPostPostRequest {
	r.updatesRequest = &updatesRequest
	return r
}

func (r ApiAppUpdatesHandlerPostPostRequest) Execute() (UpdatesResponse, *_nethttp.Response, error) {
	return r.ApiService.AppUpdatesHandlerPostPostExecute(r)
}
 ...
 * @param ctx _context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @return ApiAppUpdatesHandlerPostPostRequest
 */
func (a *DefaultApiService) AppUpdatesHandlerPostPost(ctx _context.Context) ApiAppUpdatesHandlerPostPostRequest {
	return ApiAppUpdatesHandlerPostPostRequest{
		ApiService: a,
		ctx: ctx,
	}
 ...
 * @return UpdatesResponse
 */
func (a *DefaultApiService) AppUpdatesHandlerPostPostExecute(r ApiAppUpdatesHandlerPostPostRequest) (UpdatesResponse, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodPost
		localVarPostBody     interface{}
		localVarFormFileName string
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "DefaultApiService.AppUpdatesHandlerPostPost")
	if err != nil {
		return localVarReturnValue, nil, GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/v1/updates"
	...
	// body params
	localVarPostBody = r.updatesRequest
	req, err := a.client.prepareRequest(r.ctx, localVarPath, localVarHTTPMethod, localVarPostBody, localVarHeaderParams, localVarQueryParams, localVarFormParams, localVarFormFileName, localVarFileName, localVarFileBytes)
	if err != nil {
		return localVarReturnValue, nil, err
	}
...
type ApiAppUpdatesHandlerV2GetGetRequest struct {
	ctx _context.Context
	ApiService *DefaultApiService
	nevra string
}
...
func (r ApiAppUpdatesHandlerV2GetGetRequest) Execute() (UpdatesV2Response, *_nethttp.Response, error) {
	return r.ApiService.AppUpdatesHandlerV2GetGetExecute(r)
}
 ...
 * @param ctx _context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param nevra Package NEVRA
 * @return ApiAppUpdatesHandlerV2GetGetRequest
 */
func (a *DefaultApiService) AppUpdatesHandlerV2GetGet(ctx _context.Context, nevra string) ApiAppUpdatesHandlerV2GetGetRequest {
	return ApiAppUpdatesHandlerV2GetGetRequest{
		ApiService: a,
		ctx: ctx,
		nevra: nevra,
 ...
 */
func (a *DefaultApiService) AppUpdatesHandlerV2GetGetExecute(r ApiAppUpdatesHandlerV2GetGetRequest) (UpdatesV2Response, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodGet
		localVarPostBody     interface{}
		localVarFormFileName string
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "DefaultApiService.AppUpdatesHandlerV2GetGet")
	if err != nil {
		return localVarReturnValue, nil, GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/v2/updates/{nevra}"
	localVarPath = strings.Replace(localVarPath, "{"+"nevra"+"}", _neturl.PathEscape(parameterToString(r.nevra, "")), -1)
...
type ApiAppUpdatesHandlerV2PostPostRequest struct {
	ctx _context.Context
	ApiService *DefaultApiService
	updatesRequest *UpdatesRequest
}

func (r ApiAppUpdatesHandlerV2PostPostRequest) UpdatesRequest(updatesRequest UpdatesRequest) ApiAppUpdatesHandlerV2PostPostRequest {
	r.updatesRequest = &updatesRequest
	return r
}

func (r ApiAppUpdatesHandlerV2PostPostRequest) Execute() (UpdatesV2Response, *_nethttp.Response, error) {
	return r.ApiService.AppUpdatesHandlerV2PostPostExecute(r)
}
 ...
 * List security updates for list of package NEVRAs
 * @param ctx _context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @return ApiAppUpdatesHandlerV2PostPostRequest
 */
func (a *DefaultApiService) AppUpdatesHandlerV2PostPost(ctx _context.Context) ApiAppUpdatesHandlerV2PostPostRequest {
	return ApiAppUpdatesHandlerV2PostPostRequest{
		ApiService: a,
		ctx: ctx,
	}
 ...
 * @return UpdatesV2Response
 */
func (a *DefaultApiService) AppUpdatesHandlerV2PostPostExecute(r ApiAppUpdatesHandlerV2PostPostRequest) (UpdatesV2Response, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodPost
		localVarPostBody     interface{}
		localVarFormFileName string
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "DefaultApiService.AppUpdatesHandlerV2PostPost")
	if err != nil {
		return localVarReturnValue, nil, GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/v2/updates"
...
func (a *DefaultApiService) AppUpdatesHandlerV3GetGetExecute(r ApiAppUpdatesHandlerV3GetGetRequest) (UpdatesV2Response, *_nethttp.Response, error) {
	...
	localVarPath := localBasePath + "/v3/updates/{nevra}"
	localVarPath = strings.Replace(localVarPath, "{"+"nevra"+"}", _neturl.PathEscape(parameterToString(r.nevra, "")), -1)
...
func (a *DefaultApiService) AppUpdatesHandlerV3PostPostExecute(r ApiAppUpdatesHandlerV3PostPostRequest) (UpdatesV2Response, *_nethttp.Response, error) {
	...
	localVarPath := localBasePath + "/v3/updates"
...
func (a *DefaultApiService) AppVulnerabilitiesHandlerGetGetExecute(r ApiAppVulnerabilitiesHandlerGetGetRequest) (VulnerabilitiesResponse, *_nethttp.Response, error) {
	...
	localVarPath := localBasePath + "/v1/vulnerabilities/{nevra}"
	localVarPath = strings.Replace(localVarPath, "{"+"nevra"+"}", _neturl.PathEscape(parameterToString(r.nevra, "")), -1)
...
func (a *DefaultApiService) AppVulnerabilitiesHandlerPostPostExecute(r ApiAppVulnerabilitiesHandlerPostPostRequest) (VulnerabilitiesResponse, *_nethttp.Response, error) {
	...
	localVarPath := localBasePath + "/v1/vulnerabilities"
