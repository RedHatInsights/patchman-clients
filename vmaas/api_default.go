...
type ApiAppPkgtreeHandlerV3GetGetRequest struct {
	ctx _context.Context
	ApiService *DefaultApiService
	packageName string
}
...
func (r ApiAppPkgtreeHandlerV3GetGetRequest) Execute() (PkgtreeResponse, *_nethttp.Response, error) {
	return r.ApiService.AppPkgtreeHandlerV3GetGetExecute(r)
}

/*
 * AppPkgtreeHandlerV3GetGet Method for AppPkgtreeHandlerV3GetGet
 * Get package NEVRAs tree for a single package name.
 * @param ctx _context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param packageName Package name
 * @return ApiAppPkgtreeHandlerV3GetGetRequest
 */
func (a *DefaultApiService) AppPkgtreeHandlerV3GetGet(ctx _context.Context, packageName string) ApiAppPkgtreeHandlerV3GetGetRequest {
	return ApiAppPkgtreeHandlerV3GetGetRequest{
		ApiService: a,
		ctx: ctx,
 ...
 */
func (a *DefaultApiService) AppPkgtreeHandlerV3GetGetExecute(r ApiAppPkgtreeHandlerV3GetGetRequest) (PkgtreeResponse, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodGet
		localVarPostBody     interface{}
		localVarFormFileName string
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "DefaultApiService.AppPkgtreeHandlerV3GetGet")
	if err != nil {
		return localVarReturnValue, nil, GenericOpenAPIError{error: err.Error()}
	}
...
type ApiAppPkgtreeHandlerV3PostPostRequest struct {
	ctx _context.Context
	ApiService *DefaultApiService
	pkgtreeRequest *PkgtreeRequest
}

func (r ApiAppPkgtreeHandlerV3PostPostRequest) PkgtreeRequest(pkgtreeRequest PkgtreeRequest) ApiAppPkgtreeHandlerV3PostPostRequest {
	r.pkgtreeRequest = &pkgtreeRequest
	return r
}

func (r ApiAppPkgtreeHandlerV3PostPostRequest) Execute() (PkgtreeResponse, *_nethttp.Response, error) {
	return r.ApiService.AppPkgtreeHandlerV3PostPostExecute(r)
}

/*
 * AppPkgtreeHandlerV3PostPost Method for AppPkgtreeHandlerV3PostPost
 ...
 * @param ctx _context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @return ApiAppPkgtreeHandlerV3PostPostRequest
 */
func (a *DefaultApiService) AppPkgtreeHandlerV3PostPost(ctx _context.Context) ApiAppPkgtreeHandlerV3PostPostRequest {
	return ApiAppPkgtreeHandlerV3PostPostRequest{
		ApiService: a,
		ctx: ctx,
	}
 ...
 * @return PkgtreeResponse
 */
func (a *DefaultApiService) AppPkgtreeHandlerV3PostPostExecute(r ApiAppPkgtreeHandlerV3PostPostRequest) (PkgtreeResponse, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodPost
		localVarPostBody     interface{}
		localVarFormFileName string
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "DefaultApiService.AppPkgtreeHandlerV3PostPost")
	if err != nil {
		return localVarReturnValue, nil, GenericOpenAPIError{error: err.Error()}
	}
