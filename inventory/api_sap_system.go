...
func (r ApiApiSystemProfileGetSapSidsRequest) Filter(filter map[string]OneOfmapobject) ApiApiSystemProfileGetSapSidsRequest {
	r.filter = &filter
	return r
}
...
func (r ApiApiSystemProfileGetSapSystemRequest) Filter(filter map[string]OneOfmapobject) ApiApiSystemProfileGetSapSystemRequest {
	r.filter = &filter
	return r
}
