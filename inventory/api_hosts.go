...
type ApiApiHostAddHostListRequest struct {
	ctx _context.Context
	ApiService *HostsApiService
	createHostIn *[]CreateHostIn
}

func (r ApiApiHostAddHostListRequest) CreateHostIn(createHostIn []CreateHostIn) ApiApiHostAddHostListRequest {
	r.createHostIn = &createHostIn
	return r
}

func (r ApiApiHostAddHostListRequest) Execute() (BulkHostOut, *_nethttp.Response, error) {
	return r.ApiService.ApiHostAddHostListExecute(r)
}
 ...
 * @return ApiApiHostAddHostListRequest
 */
func (a *HostsApiService) ApiHostAddHostList(ctx _context.Context) ApiApiHostAddHostListRequest {
	return ApiApiHostAddHostListRequest{
		ApiService: a,
		ctx: ctx,
	}
 ...
 * @return BulkHostOut
 */
func (a *HostsApiService) ApiHostAddHostListExecute(r ApiApiHostAddHostListRequest) (BulkHostOut, *_nethttp.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "HostsApiService.ApiHostAddHostList")
	if err != nil {
	...
	if r.createHostIn == nil {
		return localVarReturnValue, nil, reportError("createHostIn is required and must be specified")
	}
	...
	// body params
	localVarPostBody = r.createHostIn
	if r.ctx != nil {
...
func (r ApiApiHostHostCheckinRequest) Execute() (BulkHostOut, *_nethttp.Response, error) {
 ...
 * @return BulkHostOut
 */
func (a *HostsApiService) ApiHostHostCheckinExecute(r ApiApiHostHostCheckinRequest) (BulkHostOut, *_nethttp.Response, error) {
	var (
